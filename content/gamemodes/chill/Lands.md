...
## Table of Contents
1. [Creating a land](#1-creating-a-land)
2. [Land removal due to inactivity](#2-land-removal-due-to-inactivity)
3. [Trusted ban and merged lands](#3-trusted-ban-and-merged-lands)
4. [Menu](#4-menu)
...
| /lands view          | You can see both your land and other players' lands; this behaves the same as the others. $\color{green}{\text{Green}}$ (your land), $\color{red}{\text{red}}$ (another player's land without trust), $\color{yellow}{\text{yellow}}$ (land with trust)                                                                                                                                                                                                                                 |
...
## 2. Land removal due to inactivity
...
## 3. Trusted, ban and merged lands 
