...
| /lands view          | You can see both your land and other players' lands; this behaves the same as the others. ~={green}Green=~ (your land), ~={red}red =~(another player's land without trust), ~={yellow}yellow=~ (land with trust).                                                                                                                                                                                                  |
...
### 💼Management Flags
~={red}This section is crucial as it allows you to grant players permissions to claim land, build, destroy, and perform other actions. It is NOT recommended to modify these settings in an untrusted role=~
![[managament_flag.png]]
...
| Claim and unclaim           | ~={red}It's always recommended to leave this flag disabled, unless you have a lot of trust in the members of your land.=~                                                                                                                                                                       |
