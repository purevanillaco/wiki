...
![Lands menu](images/lands_menu.png)
...
| /lands claim         | Claim more chunks in a land. By default, you get 4 free chunks (including the initial one). You can expand this with claimblock, which you get by [voting](https://purevanilla.co/vote) for the server. Each land can claim an infinite number of chunks, it all depends on your "claimblock" availability. |
...
![Lands menu selection](images/lands_menu_mark.png)

**We will encounter the following menu:**

![Lands main menu](images/lands_menu_main.png)

## 🛂 Player management

![Player management](images/player_mana.png)
...
![Management flags](images/managament_flag.png)
...
![Color example](images/color%20example.png)
